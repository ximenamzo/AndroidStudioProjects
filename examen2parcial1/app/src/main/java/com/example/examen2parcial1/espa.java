...
public class espa extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rgep1.setOnCheckedChangeListener((group, checkedId) -> {
            if (checkedId == R.id.rb1ep1) {
                calif++;
                cont++;
            } else if (checkedId == R.id.rb2ep1 || checkedId == R.id.rb3ep1) {
                cont++;
            }
        });
        ...
        rgep2.setOnCheckedChangeListener((group, checkedId) -> {
            if (checkedId == R.id.rb2ep2) {
                calif++;
                cont++;
            } else if (checkedId == R.id.rb1ep2 || checkedId == R.id.rb3ep2) {
                cont++;
            }
        });
        ...
        rgep4.setOnCheckedChangeListener((group, checkedId) -> {
            if (checkedId == R.id.rb2ep4) {
                calif++;
                cont++;
            } else if (checkedId == R.id.rb1ep4 || checkedId == R.id.rb3ep4) {
                cont++;
            }
        });
        ...
        btncalifica.setOnClickListener(view -> {
            if (cont<4) {
                Toast.makeText(espa.this, "No has terminado de responder.", Toast.LENGTH_LONG).show();
            } else {
                calificacion = calif.toString();
                i = new Intent(espa.this, califica.class);
